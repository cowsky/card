...
<html>
<head>
<title>wxCloud - /src/weixin/vip/entity/WeixinVipMembersType.java - Taocode</title> 
...
<div>
    <a href="/p/wxCloud/logs/src/weixin/vip/entity/WeixinVipMembersType.java"> 历史</a>
    |
    <a href="/p/wxCloud/log/2/src/weixin/vip/entity/WeixinVipMembersType.java">r2</a>
    |
    <em>2016-03-03 15:28:54</em>
    |
    <a href="/p/wxCloud/src/src/weixin/vip/entity/WeixinVipMembersType.java?orig"> 下载</a>
</div>
  <p>
...
@Entity
@Table(name = &quot;wx_vip_members_type&quot;, schema = &quot;&quot;)
@DynamicUpdate(true)
@DynamicInsert(true)
@SuppressWarnings(&quot;serial&quot;)
public class WeixinVipMembersType implements java.io.Serializable {
	private String id;
	...
	public void setMembers_type(String members_type) {
		this.members_type = members_type;
	}
	@Column(name =&quot;individual_annual_fee&quot;)
	public String getIndividual_annual_fee() {
		return individual_annual_fee;
	}
	public void setIndividual_annual_fee(String individual_annual_fee) {
		this.individual_annual_fee = individual_annual_fee;
	}
	@Column(name =&quot;enterprise_annual_fee&quot;)
	public String getEnterprise_annual_fee() {
		return enterprise_annual_fee;
	}
	public void setEnterprise_annual_fee(String enterprise_annual_fee) {
		this.enterprise_annual_fee = enterprise_annual_fee;
	}
	@Column(name =&quot;free_exhibition_count&quot;)
	public String getFree_exhibition_count() {
		return free_exhibition_count;
	}
	public void setFree_exhibition_count(String free_exhibition_count) {
		this.free_exhibition_count = free_exhibition_count;
	}
	@Column(name =&quot;free_activity_count&quot;)
	public String getFree_activity_count() {
		return free_activity_count;
	}
	public void setFree_activity_count(String free_activity_count) {
		this.free_activity_count = free_activity_count;
	}
